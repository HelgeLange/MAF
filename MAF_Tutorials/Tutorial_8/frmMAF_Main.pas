...
uses
  ...
  uMAF_HookClient, Menus, ComCtrls, uMAF_ResourceClient, ExtCtrls,
  uMAF_WizardPanel;
...
begin
  Label1.Caption := mafResourceClient1.GetString(1);
end;
...
begin
  ...
  If Manager = 'ResourceManager' Then
    ManagerFileName := 'Router_FileDB.dll';
end;
